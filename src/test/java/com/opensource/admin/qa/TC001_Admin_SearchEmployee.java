...
public class TC001_Admin_SearchEmployee {
	...
	public void TC001_Admin_SearchEmployee_Script() {
		...
		String valueUsername = driver.findElement(By.xpath("//tbody/tr[1]/td[2]")).getText();
		//Assert.assertEquals(valueUsername, "Admin");
		SoftAssert softAssert = new SoftAssert();
		softAssert.assertEquals(valueUsername, "Admin");
